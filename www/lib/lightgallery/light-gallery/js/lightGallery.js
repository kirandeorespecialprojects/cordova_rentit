...
(function ($) {
    ...
    $.fn.lightGallery = function (options) {
        var defaults = {
                ...
                onOpen: function (plugin, data) {},
                onSlideBefore: function (plugin) {},
                onSlideAfter: function (plugin, data) {},
        ...
        var setUp = {
            ...
            slide: function (index) {
                ...
                /*kiran*/
                var eventData = { slides: $slide, prevIndex: prevIndex, currentIndex: index };
                prevIndex = index;
                lightGalleryOn === false ? settings.onOpen.call(this, plugin, eventData) : settings.onSlideAfter.call(this, plugin, eventData);
                setTimeout(function () {
                    lightGalleryOn = true;
                });
                usingThumb = false;
