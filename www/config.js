System.config({
  ...
  map: {
    ...
    "bootstrapselect": "../../lib/bootstrap-select/dist/js/bootstrap-select",
    "core-js": "npm:core-js@2.2.1",
    "fetch": "github:github/fetch@0.10.1",
    "font-awesome": "npm:font-awesome@4.5.0",
    "functions": "js/functions",
    "growl": "../../lib/bootstrap-growl/bootstrap-growl.min",
    "lightgallery": "../../lib/lightgallery/light-gallery/js/lightGallery",
    "mCustomScrollbar": "../../lib/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min",
    "sweetalert": "../../lib/bootstrap-sweetalert/lib/sweet-alert.min",
